...
export default function CreateLibrary() {
  ...
  return (
    ...
    <Box sx={{ border: '2px solid black' }} >
      <Stack spacing={1} sx={{
        border: '2px solid red', margin: "auto",
        ...
        <Paper sx={{
          ...
          >
            ...
            <Input placeholder="รายละเอียด" name="titleDes" value={note.titleDes}
              onChange={onNoteValueChange} />
            <Button variant="contained" onClick={() => OnNoteSubmit(note)}>Submit</Button>
          </Stack>
        </Paper>
        ...
        <Paper sx={{ borderRadius: "8px", padding: "30px 25px", textTransform: "capitalize", backgroundColor: "white", }}>
          <Stack direction="row" justifyContent="flex-end" alignItems="flex-start" spacing={2}>
            <Button variant="contained" onClick={() => OnNoteSubmit(note)}>Save</Button>
            <Button variant="contained" onClick={() => OnNoteSubmit(note)}>Add</Button>
